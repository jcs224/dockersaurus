...
<div class="d-flex">
  <div 
    ...
    :class="[container.State == 'running' ? 'bg-teal border-0' : '']"
  >
  ...
  <div v-else class="h-100">
    <button v-if="container.State == 'running'" class="btn btn-purple rounded-0 h-100" @click="stopContainer(container.Id)"><fai icon="fa-solid fa-stop"/></button>
