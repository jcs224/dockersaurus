...
<div class="d-flex">
  <div 
    ...
    :class="[container.State == 'running' || container.Status == 'start' ? 'bg-primary text-white border-0' : '']"
  >
    {{ container.Names[0].substring(1) }}
  </div>
  
  <button class="btn btn-success rounded-0" @click="startContainer(container.Id)">Start</button>
